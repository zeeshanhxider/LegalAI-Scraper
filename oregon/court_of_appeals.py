...
DEFAULT_BASE_URL = (
    ...
    "p17027coll8/search/order/dated/ad/desc/page/1"
)
BASE_DOMAIN = "https://cdm17027.contentdm.oclc.org"
DEFAULT_COURT_NAME = "Oregon Court of Appeals"
...
def build_csv_storage_path(downloads_dir: Path, court_name: str, csv_name: str) -> Path:
    ...
    csv_filename = "court_of_appeals_case.csv"
...
def clean_briefs_value(raw_text: str) -> str:
    ...
    for candidate in candidates:
        ...
        # Most records in this run should resolve to Oregon Court of Appeals.
        if "oregon court of appeals" in lowered:
...
def extract_briefs_value(driver: webdriver.Chrome, listing_briefs: str = "") -> str:
    ...
    for selector in selectors:
        ...
        for link in links:
            ...
            if not txt:
                continue
            if "briefs --" in txt.lower() or "Oregon Court of Appeals" in txt.lower():
    ...
    xpath_candidates = [
        ...
        "//a[contains(normalize-space(),'Oregon Court of Appeals')]",
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        help="Court folder name under downloads/ (default: Oregon Court of Appeals).",
    )
    parser.add_argument(
        "--base-url",
        type=str,
