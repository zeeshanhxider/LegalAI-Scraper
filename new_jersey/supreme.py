...
Folder structure:
- downloads/supreme/CSV/supreme.csv
- downloads/supreme/<year>/<no>/<pdf file>.pdf
"""
...
COURT_FOLDER = "supreme"

BASE_DIR = os.path.join("downloads", COURT_FOLDER)
CSV_DIR = os.path.join(BASE_DIR, "CSV")
CSV_PATH = os.path.join(CSV_DIR, "supreme.csv")
...
def parse_cards(soup: BeautifulSoup, page_url: str):
    ...
    for card in cards:
        ...
        badges = [clean_ws(x.get_text(" ", strip=True)) for x in card.select("span.badge") if clean_ws(x.get_text())]
