...
def ensure_folders(base_dir: Path) -> Dict[str, Path]:
    downloads_dir = base_dir / "downloads/unpublished_supreme_court"
    csv_dir = downloads_dir / "CSV"
    pdf_dir = downloads_dir / "PDF"
    log_dir = base_dir / "Log/unpublished_supreme_court"
...
def _parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Scrape South Carolina Supreme Court unpublished opinions.")
