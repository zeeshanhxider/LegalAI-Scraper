...
def ensure_folders(base_dir: Path) -> Dict[str, Path]:
    downloads_dir = base_dir / "downloads/published_court_of_appeals"
    csv_dir = downloads_dir / "CSV"
    pdf_dir = downloads_dir / "PDF"
    log_dir = base_dir / "Log/published_court_of_appeals"
...
def _parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Scrape South Carolina Court Of Appeals published opinions.")
