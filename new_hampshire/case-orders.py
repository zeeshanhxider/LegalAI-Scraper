...
def setup_logger() -> logging.Logger:
    ...
    logger = logging.getLogger("nh_case_orders_scraper")
    logger.setLevel(logging.INFO)
    logger.handlers.clear()

    log_name = f"nh_supreme_court_case_orders-{datetime.now().strftime('%Y-%m-%d')}.log"
...
def main() -> None:
    parser = argparse.ArgumentParser(description="NH Supreme Court Case Orders scraper")
