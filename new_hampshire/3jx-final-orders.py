...
DOWNLOADS_DIR = ROOT_DIR / "downloads/3jx_final_orders"
CSV_DIR = DOWNLOADS_DIR / "CSV"
PDF_DIR = DOWNLOADS_DIR / "PDF"
LOG_DIR = ROOT_DIR / "Log"
CSV_PATH = CSV_DIR / "nh_3jx_final_orders.csv"
...
def setup_logger() -> logging.Logger:
    ...
    log_name = f"nh_3jx_final_orders_opinions-{datetime.now().strftime('%Y-%m-%d')}.log"
